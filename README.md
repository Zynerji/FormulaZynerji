...
> Status: **v0.5.7 — draft** (car + competition complete; token-free self-balancing economy; cap/floor, engine cycle & dirty-air price all model-derived; blockchain technical spec; figures incl. Blender hero + FreeCAD-TechDraw CAD GA; 12-page LaTeX whitepaper) · License: [`LICENSE`](LICENSE) (CC BY-SA 4.0) · Maintainer: cknopp@gmail.com
>
> **Read the whitepaper:** [`whitepaper/whitepaper.pdf`](whitepaper/whitepaper.pdf) (LaTeX source `whitepaper/whitepaper.tex`). Figures in [`drawings/`](drawings/) (2D vector + a 3D `car_3d.step`); economic model in [`modeling/`](modeling/).
