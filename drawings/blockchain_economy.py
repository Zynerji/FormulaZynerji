...
box(axr,(2,21),18,12,"CHAIN R&D\nCORPUS",fc="#dfe9f3",fs=9,bold=True)
axr.text(11,17,"all teams' CAD/FEA/CFD,\ntelemetry, materials",ha="center",va="top",fontsize=7,color=MUT)
box(axr,(30,38),30,9,"Media / journalists  ($)",fc=FILL,fs=8.5)
box(axr,(30,22.5),30,10,"Industry deep-data  ($$$)\nBoeing · Lockheed · OEMs",fc="#f3ecd3",ec=GOLD,fs=8,bold=True)
box(axr,(30,7),30,9,"Public / fans  ($)",fc=FILL,fs=8.5)
for y in (42.5,27.5,11.5): arrow(axr,(20,27),(30,y),color=INK,lw=1.2)
axr.text(45,34,"largest stream",ha="center",fontsize=7,color=GOLD)
box(axr,(64,21),15,12,"SERIES\nREVENUE POOL",fc="#e3f0e8",ec=GREEN,fs=8.5,bold=True)
for y in (42.5,27.5,11.5): arrow(axr,(60,y),(64,27),color=INK,lw=1.2)
box(axr,(83,37),16,8,"sport operations",fc=FILL,fs=8)
box(axr,(83,22.5),16,9,"PRIZE MONEY\n(4 championships)",fc="#e3f0e8",ec=GREEN,fs=8,bold=True)
box(axr,(83,8),16,8,"small-team\nredistribution",fc=FILL,fs=8)
for y in (41,27,12): arrow(axr,(79,27),(83,y),color=GREEN,lw=1.3)
